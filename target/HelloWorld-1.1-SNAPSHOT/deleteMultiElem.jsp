...
<head>
    <meta charset="UTF-8">
    <title>Delete item in ${itemName}</title>
...
<body class="bg-dark">
    ...
    <div class="p-3 mb-2 bg-dark text-white">
        <center>
            <h1>Delete item in ${itemName}</h1>
            <br>
            <br>
            <br>
            <br>
            <br>
            <form action="/deleteMultiElem" method="post">
                <p>
                ...
                <button type="submit" class="btn btn-outline-light">Delete Item</button>
            </form>
            <br>
